...
--
-- Phase 4 (T020/T021) shipped budget.categories and budget.transactions as
...
DROP TABLE IF EXISTS budget.transactions CASCADE;
DROP TABLE IF EXISTS budget.categories CASCADE;
DROP FUNCTION IF EXISTS budget.assert_transaction_category_owner() CASCADE;
